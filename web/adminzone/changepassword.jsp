        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12" style="background-color: pink;min-height:600px;">
                    ...
                    <form class="form-group" id="frmchangepassword" method="post" onsubmit="event.preventDefault(); validate();" action="admincontroller.jsp">
                        ...
                        <table class="table table-bordered" style="margin: auto;width: 70%;">
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <button type="submit" class="btn btn-success">Change Password</button>  </td>
                            </tr>
                        </table>
                    </form>
                </div>
