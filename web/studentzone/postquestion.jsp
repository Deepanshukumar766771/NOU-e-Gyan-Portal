    ...
    <body>
        ...
        <div class="row">
            <div class="col-sm-12" style="background-color:pink; min-hight:600px;">
                <h2 style="color: blue;text-align: center;">Discussion Form</h2>
        ...
        <tr>
            ...
            <td><%=rs.getString("question")%></td>
              <td><%=rs.getString("askby")%></td>
                <td><%=rs.getString("posteddate")%></td>
                <td>
                    <a href="postanswer.jsp?qid=<%=rs.getInt("qid")%>">
                        <button type="button" class="btn btn-primary">Post Answer</button>
                    </a>
                </td>
                <td>
                    <a href="viewanswer.jsp?qid=<%=rs.getInt("qid")%>">
